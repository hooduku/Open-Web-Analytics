...
define('OWA_DB_TYPE', 'sqlserver'); // options: mysql
define('OWA_DB_NAME', 'owa'); // name of the database
define('OWA_DB_HOST', 'tcp:cp8k3jteql.database.windows.net,1433'); // host name of the server housing the database
define('OWA_DB_USER', 'owauser@cp8k3jteql'); // database user
define('OWA_DB_PASSWORD', 'Owa$77$Pwd'); // database user's password
